export declare const baseApiUrl = "https://api-dev.proj-terra.com/v1";
export declare const treeUrl: string;
export declare const VRPinUrl: string;
export declare type ApiVideoModelType = "series" | "sessions";
